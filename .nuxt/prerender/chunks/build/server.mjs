...
import { getContext, executeAsync } from 'file://C:/Users/DELL/konaseema_ghumaghumalu/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file://C:/Users/DELL/konaseema_ghumaghumalu/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/Users/DELL/konaseema_ghumaghumalu/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file://C:/Users/DELL/konaseema_ghumaghumalu/node_modules/radix3/dist/index.mjs';
import { defu } from 'file://C:/Users/DELL/konaseema_ghumaghumalu/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://C:/Users/DELL/konaseema_ghumaghumalu/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/Users/DELL/konaseema_ghumaghumalu/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "menu",
    path: "/menu",
    component: () => import('./menu-Mw3yS7Jb.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./about-C7OtjH1C.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-5pvqOG1o.mjs')
  },
  {
    name: "order",
    path: "/order",
    component: () => import('./order-BWZDPc7u.mjs')
  },
  {
    name: "quote",
    path: "/quote",
    component: () => import('./quote-CT4PBEhW.mjs')
  },
  {
    name: "quote1",
    path: "/quote1",
    component: () => import('./quote1-XnTZaPfB.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-Dq3nJWSz.mjs')
  },
  {
    name: "gallery",
    path: "/gallery",
    component: () => import('./gallery-BQieakrn.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-D9tUG7Sh.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-ClPk8b4o.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-v9XaKLpJ.mjs'));
