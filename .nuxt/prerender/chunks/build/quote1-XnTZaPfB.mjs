...
import { reactive, ref, computed, withCtx, createTextVNode, useSSRContext } from 'file://C:/Users/DELL/konaseema_ghumaghumalu/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderClass, ssrRenderComponent } from 'file://C:/Users/DELL/konaseema_ghumaghumalu/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></section><section class="why-choose-us" data-v-3836bc62><div class="container" data-v-3836bc62><h2 data-v-3836bc62>Why Choose Our Catering Services?</h2><div class="features-grid" data-v-3836bc62><div class="feature-card" data-v-3836bc62><div class="feature-icon" data-v-3836bc62>\u{1F37D}\uFE0F</div><h3 data-v-3836bc62>Authentic Flavors</h3><p data-v-3836bc62> Traditional Andhra recipes prepared by experienced chefs using authentic spices and techniques. </p></div><div class="feature-card" data-v-3836bc62><div class="feature-icon" data-v-3836bc62>\u{1F468}\u200D\u{1F373}</div><h3 data-v-3836bc62>Professional Service</h3><p data-v-3836bc62> Experienced catering team ensuring seamless service and presentation for your special event. </p></div><div class="feature-card" data-v-3836bc62><div class="feature-icon" data-v-3836bc62>\u{1F33F}</div><h3 data-v-3836bc62>Fresh Ingredients</h3><p data-v-3836bc62> We use only the freshest, locally sourced ingredients to ensure the highest quality dishes. </p></div><div class="feature-card" data-v-3836bc62><div class="feature-icon" data-v-3836bc62>\u{1F4B0}</div><h3 data-v-3836bc62>Competitive Pricing</h3><p data-v-3836bc62> Affordable catering packages without compromising on quality or taste. </p></div></div></div></section><section class="contact-cta" data-v-3836bc62><div class="container" data-v-3836bc62><h2 data-v-3836bc62>Need to Discuss Your Event?</h2><p data-v-3836bc62> Our catering specialists are here to help you plan the perfect menu for your occasion. </p><div class="cta-buttons" data-v-3836bc62><a href="tel:+917674800999" class="btn btn-primary" data-v-3836bc62>Call Us: 076748 00999</a>`);
...
export { quote1 as default };
//# sourceMappingURL=quote1-XnTZaPfB.mjs.map
