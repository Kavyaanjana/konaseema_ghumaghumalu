  ...
  <div>
    ...
    <section class="section-padding bg-gradient-to-r from-orange-50 to-orange-100">
      <div class="container-max text-center">
        <h1 class="text-4xl md:text-5xl font-bold mb-6 text-gray-800">Contact Us</h1>
        <p class="text-xl text-gray-600 max-w-3xl mx-auto">
          Get in touch with us for reservations, inquiries, or to learn more about our authentic Andhra cuisine.
        </p>
      </div>
    </section>
          ...
          <div>
            ...
            <div class="space-y-6">
              ...
              <div class="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p class="text-gray-600">
                    info@konaseema.com<br>
                    reservations@konaseema.com
                  </p>
                </div>
              </div>
            ...
            <div class="mt-8">
              ...
              <div class="flex space-x-4">
                <a href="#" class="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center text-white hover:bg-orange-600 transition-colors">
    ...
    <section class="bg-gray-100">
      <div class="h-96 bg-gray-300 flex items-center justify-center">
        <div class="text-center">
          ...
          <p class="text-gray-500">KPHB Phase 1, Kukatpally, Hyderabad</p>
        </div>
      </div>
    </section>
  </div>
